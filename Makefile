...
#Store BOOTLOADER BOARD ID in last byte of EEPROM
EEPROM_BOARD_ID_ADDR = E2END
...
CDEFS += -DEEPROM_BOARD_ID_ADDR=$(EEPROM_BOARD_ID_ADDR)

# Place -D or -U options here for ASM sources
ADEFS  = -DF_CPU=$(F_CPU)
#ADEFS += -DBOOTLOADER_BOARD_ID=$(BOOTLOADER_BOARD_ID)
ADEFS += -DEEPROM_BOARD_ID_ADDR=$(EEPROM_BOARD_ID_ADDR)

# Place -D or -U options here for C++ sources
CPPDEFS  = -DF_CPU=$(F_CPU)UL
#CPPDEFS += -DBOOTLOADER_BOARD_ID=$(BOOTLOADER_BOARD_ID)
CPPDEFS += -DEEPROM_BOARD_ID_ADDR=$(EEPROM_BOARD_ID_ADDR)
